...
export function EditReviewField({
  ...
  rows = 4,
  onChange,
}: EditReviewFieldProps) {
  const fieldClassName = cn(
    "w-full rounded-[8px] border border-primary bg-[#fbf8eb]/10 px-3 text-sm leading-5 font-medium text-dark outline-none transition-colors placeholder:text-[#98a2b3] focus:ring-2 focus:ring-primary/10 disabled:cursor-not-allowed disabled:opacity-60",
      ...
      <div className="relative">
        {multiline ? (
          <textarea
            ...
            className={cn(fieldClassName, "min-h-[132px] resize-y py-3")}
          />
        ) : (
          <input
            id={id}
